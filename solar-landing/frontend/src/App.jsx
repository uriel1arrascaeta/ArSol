          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white/10 p-8 rounded-2xl border border-white/10 shadow-lg text-center">
                ...
                <a 
                    ...
                    className="w-full bg-green-500 text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-green-600 transition-all shadow-xl hover:shadow-green-500/40 flex items-center justify-center gap-3 group">
